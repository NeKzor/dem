...
<Tabs groupId="lang">
  ...
  struct demo_t {
    ...
    std::vector<demo_message_t> demo_messages;
  };
  ```
  ...
  class Demo {
    ...
    public List<DemoMessage> DemoMessages { get; set; }
  }
  ```
  ...
  class Demo {
    ...
    public demoMessages?: DemoMessage[];
  }
  ```
  ...
  pub struct Demo {
    ...
    pub demo_messages: Vec<DemoMessage>,
  }
  ```
